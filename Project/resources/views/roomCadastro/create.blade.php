...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
    ...
    <div class="offcanvas-body">
        <p><a class="brutalist-card__button brutalist-card__button--mark" href='/cadastroQuarto'>Cadastrar Quarto</a>
        </p>
...
<div class="cadastroQuarto border theme">
    <form action="{{ route('rooms.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <br>
        <label class="label">
            <input type="text" class="input" name="tipo" placeholder="" required="">
            <span>Tipo:</span>
        </label>
        <br><br>
        <label class="label">
            <input type="number" class="input" placeholder="" required="" name="preco" />
            <span>Preço</span>
        </label>        
        <br><br>
        <label class="label">
            <input type="name" class="input" holder="" required="" id="nome" name="nome">
            <span>Nome</span>
        </label>
        <br>    <br>
        <div class="container-input">
            <div class="radio-input">
                ...
                <label class="label1">
                    <input type="radio" id="value-1" checked="" name="dispo" value="1" />
                    <p class="text">Sim</p>
                </label>
                <label class="label1">
                    <input type="radio" id="value-2" name="dispo" value="0" />
                    <p class="text">Não</p>
                </label>
            </div>
        </div>
